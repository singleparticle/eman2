...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/build/local/bin',
    'default_mod_dir':    '/build/local/lib/python2.7/site-packages',
    'default_sip_dir':    '/build/local/share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/build/local/include/python2.7',
    'py_inc_dir':         '/build/local/include/python2.7',
    'py_lib_dir':         '/build/local/lib/python2.7/config',
    'py_version':         0x020703,
    'sip_bin':            '/build/local/bin/sip',
    'sip_config_args':    '--bindir /build/local/bin --destdir /build/local/site-packages --incdir /build/local/include --sipdir /build/local/share/sip',
    'sip_inc_dir':        '/build/local/include',
    'sip_mod_dir':        '/build/local/site-packages',
