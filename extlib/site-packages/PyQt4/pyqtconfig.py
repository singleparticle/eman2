...
_pkg_config = {
    'pyqt_bin_dir':      '/build/local/bin',
    'pyqt_config_args':  '--confirm-license -e QtCore -e QtGui -e QtOpenGL -e QtSvg',
    'pyqt_mod_dir':      '/build/local/lib/python2.7/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtOpenGL QtSvg',
    'pyqt_sip_dir':      '/build/local/share/sip/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_8_4 -x Py_v3 -g',
    'pyqt_version':      0x040a00,
    'pyqt_version_str':  '4.10',
    'qt_data_dir':       '/build/local',
    'qt_dir':            '/build/local',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '/build/local/include',
    'qt_lib_dir':        '/build/local/lib',
    'qt_threaded':       1,
    'qt_version':        0x040804,
    'qt_winconfig':      'shared'
}
